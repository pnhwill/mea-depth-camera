...
class OldListViewController: UICollectionViewController {
    ...
    var viewModel: OldListViewModel?
...
//        configuration.interSectionSpacing = 20
    ...
    private func createListCellRegistration() -> UICollectionView.CellRegistration<OldListTextCell, Item.ID> {
        return UICollectionView.CellRegistration<OldListTextCell, Item.ID> { [weak self] (cell, indexPath, itemID) in
